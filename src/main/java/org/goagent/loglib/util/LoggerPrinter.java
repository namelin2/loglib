...
final class LoggerPrinter implements Printer
{
    ...
    public synchronized void log(int priority, String tag, String message, Throwable throwable)
    {
        ...
        final String header = logHeaderContent(priority, tag, methodCount);
        logMessage.append("\n").append(TOP_BORDER).append("\n")
                .append("\n").append(header).append("\n")
                .append("\n").append(HORIZONTAL_DOUBLE_LINE).append(" ").append(message).append("\n")
                .append("\n").append(BOTTOM_BORDER).append("\n");
        LogWriteToFile.getInstance().writeLog(logMessage.toString());
